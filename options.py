...
parser.add_argument('--dataset_datetime', type=str, default='21060909', choices=['21060909', '21061212', '21061515'])
parser.add_argument('--min_uc', type=int, default=2, help='Only keep users with more than min_uc ratings')
